...
export default class ContentTypeCacheComponent extends React.Component {
  ...
  public render(): React.ReactNode {
    return (
      <div>
        <h2>
          <span className="fa fa-globe"></span> H5P Hub content type list
        </h2>
        <p>
          The list of content types displayed in the editor must regularly be
          fetched from the H5P Hub. If the list is outdated, you can manually
          fetch it here.
        </p>
        <div>
          Last update:{' '}
