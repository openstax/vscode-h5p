...
import { H5PPlayerComponent, IxAPIEvent, IContext } from './H5PPlayer';
import { IH5PInstance, IH5P } from './H5PTypes';
...
export default class H5PPlayerUI extends Component<IH5PPlayerUIProps> {
	 ...
	 */
	public hasCopyrightInformation(): boolean | undefined {
		return this.h5pPlayer.current?.hasCopyrightInformation();
	}

	public render(): ReactNode {
		return <h5p-player ref={this.h5pPlayer} content-id={this.props.contentId} h5p-url={this.props.h5pUrl} />;
	}
	...
	private loadContentCallbackWrapper = (contentId: string): Promise<IPlayerModel> =>
		this.props.loadContentCallback(contentId);
