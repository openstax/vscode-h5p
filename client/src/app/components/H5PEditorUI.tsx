...
import { H5PEditorComponent as H5PEditorWebComponent } from './H5PEditor';
...
export default class H5PEditorUI extends Component<IH5PEditorUIProps> {
	...
	public render(): ReactNode {
		return ( 
			<h5p-editor ref={this.h5pEditor} content-id={this.props.contentId} h5p-url={this.props.h5pUrl}></h5p-editor>
		);
	}
