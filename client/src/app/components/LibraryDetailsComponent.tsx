        ...
        <div>
          <table className="table-sm table-borderless">
            ...
            <tbody>
              ...
              <tr>
                <th>Restricted (can only be used with privilege)</th>
              ...
              <tr>
                <th>
                  Objects created with this library as the main content type
                </th>
                <td>{props.details.instancesCount}</td>
              </tr>
              <tr>
                <th>
                  Objects in which this library is used by another library
                </th>
                <td>{props.details.instancesAsDependencyCount}</td>
              </tr>
            </tbody>
          </table>
        </div>
